  ...
  test("POST /tweets", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        tweetUpdatedAt: CREATE_RESULT.tweetUpdatedAt.toISOString(),
      ...
      .expect([
        {
          ...
          tweetUpdatedAt: FIND_MANY_RESULT[0].tweetUpdatedAt.toISOString(),
  ...
  test("GET /tweets/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        tweetUpdatedAt: FIND_ONE_RESULT.tweetUpdatedAt.toISOString(),
